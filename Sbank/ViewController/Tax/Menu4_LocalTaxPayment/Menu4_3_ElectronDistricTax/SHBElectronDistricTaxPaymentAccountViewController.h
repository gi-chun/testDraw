//
//  SHBElectronDistricTaxPaymentAccountViewController.h
//  ShinhanBank
//
...
@interface SHBElectronDistricTaxPaymentAccountViewController : SHBBaseViewController <SHBListPopupViewDelegate, SHBSecureDelegate>
{
    ...
    IBOutlet SHBSecureTextField         *secureTextField1;          // 출금계좌비밀번호

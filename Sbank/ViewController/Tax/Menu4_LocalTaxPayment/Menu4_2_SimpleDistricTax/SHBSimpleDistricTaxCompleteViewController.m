//
//  SHBSimpleDistricTaxCompleteViewController.m
//  ShinhanBank
//
...
#import "SHBSimpleDistricTaxCompleteViewController.h"

@interface SHBSimpleDistricTaxCompleteViewController ()

@end

@implementation SHBSimpleDistricTaxCompleteViewController
...
//    label4.text = [self.dicDataDictionary objectForKey:@"과세표준금액"];

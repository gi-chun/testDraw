//
//  SHBDistricTaxCompleteViewController.h
//  ShinhanBank
//
...
@interface SHBDistricTaxCompleteViewController : SHBBaseViewController
{
    ...
    IBOutlet UILabel        *label4;        // 납기내날짜
    IBOutlet UILabel        *label5;        // 납기후날짜
    IBOutlet UILabel        *label6;        // 납부금액
    IBOutlet UILabel        *label7;        // 출금계좌번호
    IBOutlet UILabel        *label8;        // 납부일
}

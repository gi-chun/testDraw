//
//  SHBSelfDistricTaxPaymentSecurityViewController.h
//  ShinhanBank
//
...
@interface SHBSelfDistricTaxPaymentSecurityViewController : SHBBaseViewController <SHBSecretCardDelegate, SHBSecretOTPDelegate>
{

//
//  SHBLoanInterestRateReductionViewController.m
//  ShinhanBank
//
...
#import "SHBLoanInterestRateReductionViewController.h"

@interface SHBLoanInterestRateReductionViewController ()

@end

@implementation SHBLoanInterestRateReductionViewController
...
- (void)viewDidLoad
{
    ...
    self.strBackButtonTitle = @"금리인하 요구권 안내";
    
    _infoWV.delegate = self;
    [[[_infoWV subviews] lastObject] setBounces:NO];
    
    NSString *URL = [NSString stringWithFormat:@"https://%@.shinhan.com/sbank/loan/loan_rate_info.jsp", AppInfo.realServer ? @"m" : @"dev-m"];

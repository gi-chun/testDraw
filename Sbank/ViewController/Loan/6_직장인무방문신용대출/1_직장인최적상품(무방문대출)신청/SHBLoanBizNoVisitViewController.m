//
//  SHBLoanBizNoVisitViewController.m
//  ShinhanBank
//
...
#import "SHBLoanBizNoVisitViewController.h"

#import "SHBLoanBizNoVisitInfoViewController.h" // 직장인 최적상품(무방문대출) 신청 사전안내

@interface SHBLoanBizNoVisitViewController ()

@end

@implementation SHBLoanBizNoVisitViewController
...
- (void)viewDidLoad
{
    ...
    self.strBackButtonTitle = @"직장인 최적상품(무방문대출) 신청 안내";
    
    [[[_infoWV subviews] lastObject] setBounces:NO];
    
    NSString *URL = [NSString stringWithFormat:@"https://%@.shinhan.com/sbank/loan/loan_novisit_detail.jsp", AppInfo.realServer ? @"m" : @"dev-m"];
...
{
    SHBLoanBizNoVisitInfoViewController *viewController = [[[SHBLoanBizNoVisitInfoViewController alloc] initWithNibName:@"SHBLoanBizNoVisitInfoViewController" bundle:nil] autorelease];

//
//  SHBLoanCommonInterestPayCompleteViewController.m
//  ShinhanBank
//
...
@interface SHBLoanCommonInterestPayCompleteViewController ()

@end

@implementation SHBLoanCommonInterestPayCompleteViewController

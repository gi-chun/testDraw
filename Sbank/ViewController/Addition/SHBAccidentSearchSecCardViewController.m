//
//  SHBAccidentSearchSecCardViewController.m
//  ShinhanBank
//
...
#import "SHBAccidentSearchSecCardViewController.h"
#import "SHBCustomerService.h"

@interface SHBAccidentSearchSecCardViewController ()

@end

@implementation SHBAccidentSearchSecCardViewController
...
- (void)viewDidLoad
{
	...
	// E4110 전문호출
    self.service = nil;
    self.service = [[[SHBCustomerService alloc] initWithServiceId:CUSTOMER_E4110_SERVICE viewController: self] autorelease];
    self.service.requestData = [[[SHBDataSet alloc] init] autorelease];
    [self.service start];

    // 등록된 분실 보안카드가 없을때의 서버얼럿을 받았을때를 처리하기 위한 노티

//
//  SHBFundDrawingApplyCompleteViewController.m
//  ShinhanBank
//
...
@interface SHBFundDrawingApplyCompleteViewController ()
{
...
@implementation SHBFundDrawingApplyCompleteViewController
...
//    basicLabel01.text = [dicDataDictionary objectForKey:@"펀드명"];
    ...
    basicLabel06.text = [dicDataDictionary objectForKey:@"출금신청금액"];
    basicLabel07.text = [dicDataDictionary objectForKey:@"출금취소일자"];
    //    basicLabel07.text = [dicDataDictionary objectForKey:@"출금계좌번호"];
}

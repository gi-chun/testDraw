//
//  SHBFundDrawingApplySecurityCardViewController.h
//  ShinhanBank
//
...
@interface SHBFundDrawingApplySecurityCardViewController : SHBBaseViewController<SHBSecretCardDelegate, SHBSecretOTPDelegate>
{
    NSDictionary *data_D6010Info;

//
//  SHBCardUseInputViewController.m
//  ShinhanBank
//
...
#import "SHBCardUseInputViewController.h"
#import "SHBUtility.h" // 유틸
#import "SHBCardService.h" // 서비스

#import "SHBListPopupView.h" // list popup

#import "SHBCardUseListViewController.h" // 이용내역조회 완료
...
@interface SHBCardUseInputViewController ()
...
@implementation SHBCardUseInputViewController
...
- (void)viewDidLoad
{
    ...
    self.strBackButtonTitle = @"이용내역조회 정보입력";
...
- (IBAction)okBtn:(UIButton *)sender
{
    ...
    SHBCardUseListViewController *viewController = [[[SHBCardUseListViewController alloc] initWithNibName:@"SHBCardUseListViewController" bundle:nil] autorelease];

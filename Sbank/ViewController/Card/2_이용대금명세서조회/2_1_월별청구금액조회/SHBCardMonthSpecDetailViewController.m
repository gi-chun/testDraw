//
//  SHBCardMonthSpecDetailViewController.m
//  ShinhanBank
//
...
#import "SHBCardMonthSpecDetailViewController.h"
#import "SHBCardService.h" // 서비스

@interface SHBCardMonthSpecDetailViewController ()

@end

@implementation SHBCardMonthSpecDetailViewController
...
- (void)viewDidLoad
{
    ...
    self.service = nil;
    self.service = [[[SHBCardService alloc] initWithServiceCode:CARD_E2914
...
- (BOOL)onParse:(OFDataSet *)aDataSet string:(NSData *)aContent
{
    ...
    [aDataSet insertObject:[NSString stringWithFormat:@"%@원", aDataSet[@"현금서비스금액"]]
                    forKey:@"_현금서비스금액"
                   atIndex:0];
    [aDataSet insertObject:[NSString stringWithFormat:@"%@원", aDataSet[@"연회비"]]
                    forKey:@"_연회비"
                   atIndex:0];
    ...
    [aDataSet insertObject:[NSString stringWithFormat:@"%@원", aDataSet[@"제수수료"]]
                    forKey:@"_제수수료"
                   atIndex:0];
    [aDataSet insertObject:[NSString stringWithFormat:@"%@원", aDataSet[@"전월미결제금액"]]
                    forKey:@"_전월미결제금액"
                   atIndex:0];

//
//  SHBCardPaymentDetailViewController.m
//  ShinhanBank
//
...
#import "SHBCardPaymentDetailViewController.h"
#import "SHBUtility.h" // 유틸
#import "SHBCardService.h" // 서비스

@interface SHBCardPaymentDetailViewController ()

@end

@implementation SHBCardPaymentDetailViewController
...
- (void)viewDidLoad
{
    ...
    self.service = nil;
    self.service = [[[SHBCardService alloc] initWithServiceCode:CARD_E2904
                                                 viewController:self] autorelease];
    
    [self.service setTableView:_dataTable
             tableViewCellName:@"SHBCardPaymentDetailCell"
...
- (BOOL)onParse:(OFDataSet *)aDataSet string:(NSData *)aContent
{
    ...
    [aDataSet insertObject:@"결제내역조회 완료"
                    forKey:@"_타이틀"
                   atIndex:0];

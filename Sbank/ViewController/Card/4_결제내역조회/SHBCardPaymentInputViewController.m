//
//  SHBCardPaymentInputViewController.m
//  ShinhanBank
//
...
#import "SHBCardPaymentInputViewController.h"
#import "SHBUtility.h" // 유틸
#import "SHBCardService.h" // 서비스

#import "SHBListPopupView.h" // list popup

#import "SHBCardPaymentDetailViewController.h" // 결제내역조회 완료

enum CARDPAYMENT_PEROIDBTN {
    CARDPAYMENT_ONEWEEK = 100,
    CARDPAYMENT_ONEMONTH,
    CARDPAYMENT_TWOMONTH
};

@interface SHBCardPaymentInputViewController ()
...
@implementation SHBCardPaymentInputViewController
...
- (void)viewDidLoad
{
    ...
    [self setTitle:@"결제내역조회"];
    self.strBackButtonTitle = @"결제내역조회 정보입력";
...
- (IBAction)okBtn:(UIButton *)sender
{
    ...
    NSString *monthDate = [[SHBUtility dateStringToDate:_endDateField.textField.text toMonth:-2 toDay:0] stringByReplacingOccurrencesOfString:@"." withString:@""];
    ...
    SHBCardPaymentDetailViewController *viewController = [[[SHBCardPaymentDetailViewController alloc] initWithNibName:@"SHBCardPaymentDetailViewController" bundle:nil] autorelease];

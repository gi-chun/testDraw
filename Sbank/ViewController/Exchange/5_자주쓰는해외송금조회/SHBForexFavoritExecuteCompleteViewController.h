//
//  SHBForexFavoritExecuteCompleteViewController.h
//  ShinhanBank
//
...
@interface SHBForexFavoritExecuteCompleteViewController : SHBBaseViewController

@property (retain, nonatomic) IBOutlet UIView *mainView;
@property (retain, nonatomic) IBOutlet UIView *subMainView;

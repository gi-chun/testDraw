//
//  SHBAccidentSecCardInfoViewController.m
//  ShinhanBank
//
...
#import "SHBAccidentSecCardInfoViewController.h"
#import "SHBCustomerService.h" // 서비스

#import "SHBAccidentSecCardCompleteViewController.h" // 보안카드 사고신고 완료

@interface SHBAccidentSecCardInfoViewController ()
...
@implementation SHBAccidentSecCardInfoViewController
...
- (void)getElectronicSignResult:(NSNotification *)notification
{
    ...
    if (!AppInfo.errorType) {
        SHBAccidentSecCardCompleteViewController *viewController = [[[SHBAccidentSecCardCompleteViewController alloc] initWithNibName:@"SHBAccidentSecCardCompleteViewController" bundle:nil] autorelease];
...
- (IBAction)yesBtn:(UIButton *)sender
{
    ...
    AppInfo.electronicSignCode = CUSTOMER_E4112;
    AppInfo.electronicSignTitle = @"보안카드 사고신고";
    ...
    self.service = nil;
    self.service = [[[SHBCustomerService alloc] initWithServiceCode:CUSTOMER_E4112

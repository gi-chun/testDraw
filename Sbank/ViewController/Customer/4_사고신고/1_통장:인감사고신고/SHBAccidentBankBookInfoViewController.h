//
//  SHBAccidentBankBookInfoViewController.h
//  ShinhanBank
//
...
@interface SHBAccidentBankBookInfoViewController : SHBBaseViewController
...
@property (retain, nonatomic) IBOutlet SHBButton *account; // 신고계좌번호선택

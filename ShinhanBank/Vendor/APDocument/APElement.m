...
+ (id)elementWithName:(NSString*)aName {
	return [[[APElement alloc] initWithName:[[NSString alloc] initWithString:aName]] autorelease];
}
...
- (NSArray*)arrAttributeNames
{
	return [attributes allKeys];
}

- (BOOL) containAttributeName:(NSString *)attName
{
	if([attributes objectForKey:attName] == nil)
	{
		return NO;
	}
